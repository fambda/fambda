namespace Fambda.Contracts
{
    internal static class ExceptionMessage
    {
        ...
        internal const string EnumerationKeyMustNotContainLeadingSpace = "Enumeration key must not contain leading space.";
        internal const string EnumerationKeyMustNotContainTrailingSpace = "Enumeration key must not contain trailing space.";
    }
}
